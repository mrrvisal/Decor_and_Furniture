...
<head>
    ...
    <title><?= e($pageTitle) ?> | Admin - Luxery</title>
...
<a href="<?= base_url('admin/stock-alerts') ?>" class="nav-link">
    ...
    <span>Stock Alerts</span>
                ...
                <div class="admin-dropdown">
                    ...
                    <div class="admin-dropdown-menu">
                        ...
                        <a href="#" class="admin-logout logout-trigger"
                            data-logout-url="<?= base_url('auth/admin-logout') ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
    ...
    <footer class="admin-footer">
        <div class="container">
            <p>&copy; <?= date('Y') ?> Decor & Furniture Admin Panel</p>
        </div>
    </footer>
    ...
    <div class="modal-overlay" id="logout-modal">
        <div class="modal">
            ...
            <div class="modal-footer">
                ...
                <a href="#" class="btn btn-primary modal-confirm" id="logout-confirm-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
                        <polyline points="16 17 21 12 16 7"></polyline>
